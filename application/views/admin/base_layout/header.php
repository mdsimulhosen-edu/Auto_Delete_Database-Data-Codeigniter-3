        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="<?php echo base_url() ?>assets/admin//images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="<?php echo base_url() ?>assets/admin//images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect">
                    <a class="dropdown-item text-danger" href="#" style="font-size: 15px; font-weight: bold;"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Logout</span></a>
                </button>
            </div>
        </div>
    </div>
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo base_url('homeSlider') ?>" key="t-tui-calendar">
                        <i class="fa-solid fa-sliders"></i>Home Slider</a>
                </li>
                <li><a href="<?php echo base_url('channels') ?>" key="t-full-calendar">
                        <i class="fa-solid fa-tv"></i>
                        <span>Channels</span>
                    </a>
                </li>
                <!-- <li><a href="<?php echo base_url('cricket') ?>">
