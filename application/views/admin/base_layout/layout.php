...
<!-- Mirrored from themesbrand.com/skote/layouts/ui-video.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Aug 2022 02:44:04 GMT -->
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <?php $this->load->view('admin/base_layout/header'); ?>
        ...
        <!-- end main content-->
        <?php $this->load->view('admin/base_layout/footer'); ?>

    </div>
    <!-- <?php $this->load->view('admin/base_layout/sidebar'); ?> -->
    ...
    <!-- ===================================== Data Table =========================================  -->
    <script src="<?php echo base_url() ?>assets/admin/datatable/js/datatable.js"></script>
    <script src="<?php echo base_url() ?>assets/admin/datatable/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url() ?>assets/admin/js/aes.js"></script>
    <!-- ===================================== Data Table =========================================  -->



    <!-- +++++++++++++++++++ app.js File Need to add in layout.php page in script tag ++++++++++++++++++++++++++  -->
    <script>
        ! function(s) {
            "use strict";
            ...
            function a(e) {
                document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "<?php echo base_url() ?>assets/admin/images/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "<?php echo base_url() ?>assets/admin/images/flags/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "<?php echo base_url() ?>assets/admin/images/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "<?php echo base_url() ?>assets/admin/images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "<?php echo base_url() ?>assets/admin/images/flags/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && a(n), s.getJSON("<?php echo base_url() ?>assets/admin/lang/" + t + ".json", function(e) {
            ...
            function r(e) {
                1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("html").removeAttr("dir"), s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "<?php echo base_url() ?>assets/admin/css/bootstrap.min.css"), s("#app-style").attr("href", "<?php echo base_url() ?>assets/admin/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("html").removeAttr("dir"), s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "<?php echo base_url() ?>assets/admin/css/bootstrap-dark.min.css"), s("#app-style").attr("href", "<?php echo base_url() ?>assets/admin/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "<?php echo base_url() ?>assets/admin/css/bootstrap-rtl.min.css"), s("#app-style").attr("href", "<?php echo base_url() ?>assets/admin/css/app-rtl.min.css"), s("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == s("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "<?php echo base_url() ?>assets/admin/css/bootstrap-dark-rtl.min.css"), s("#app-style").attr("href", "<?php echo base_url() ?>assets/admin/css/app-dark-rtl.min.css"), s("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
            }
